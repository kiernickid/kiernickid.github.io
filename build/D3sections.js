var D3sections = window.D3Sections || (function(){
    ...
    const options = {
          ...
          // discarded.
          runLastState: config.d3sections.runLastState == undefined ? !config.d3sections.runLastState : config.d3sections.runLastState, //default true
          ...
          keepIframe: config.d3sections.keepIframe == undefined ? !!config.d3sections.keepIframe : config.d3sections.keepIframe, // default: false
          ...
          mapPath: typeof(config.d3sections.mapPath) == 'string' ? config.d3sections.mapPath : ( config.d3sections.mapPath ? 'src' : '' ),
          ...
          tryFallbackURL: config.d3sections.tryFallbackURL == undefined ? !!config.d3sections.tryFallbackURL : config.d3sections.tryFallbackURL, //default false
        };
